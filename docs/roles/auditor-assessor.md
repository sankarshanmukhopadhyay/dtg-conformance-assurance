...
2. Pull required COs from the conformance profile (`conformance/profiles/`).
3. Use `controls/control_catalog.csv` to enumerate required controls, evidence, and tests.
