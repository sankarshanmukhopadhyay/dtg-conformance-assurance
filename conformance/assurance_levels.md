...
## 2. AL1 — Declared Conformance

AL1 represents self-declared conformance without required independent review.
...
### 2.2 Constraints
AL1 **SHALL NOT** be used for profiles that mitigate material ecosystem-wide risk unless the ecosystem explicitly records risk acceptance and residual risk rationale.

---

## 3. AL2 — Documented & Reviewable

AL2 introduces structured evaluation with reviewable artefacts.
...
### 3.2 Independence
Independence is **not required** at AL2. However:
- Evidence and procedures **SHALL** be structured so that an external reviewer could evaluate them.

---

## 4. AL3 — Independent Assessment

AL3 introduces independent evaluation and stronger substantiation.
...
For AL3, independence **SHALL** satisfy all of the following:
...
If independence cannot be established, the claim **SHALL NOT** be represented as AL3.

### 4.3 Periodicity
AL3 claims **SHALL** declare a coverage window and **SHALL** define reassessment cadence appropriate to risk.

---

## 5. AL4 — Continuous & High-Assurance

AL4 represents the highest rigor level in DCAS v0.1, emphasizing continuous substantiation for critical controls.

### 5.1 Required characteristics
At AL4:
- The evaluation model **SHALL** include independent assessment (as per AL3).
...
### 5.2 Constraints
AL4 does not require public disclosure of sensitive evidence.  
However, AL4 claims **SHALL** include integrity anchors and defined audit access mechanisms where evidence is restricted.
...
Additionally:
- AL2+ claims **SHALL** include references to evidence and/or tests used.
- AL3+ claims **SHALL** identify the assessor and disclose the independence model.
- AL4 claims **SHALL** include monitoring description for critical controls and integrity anchors where evidence is restricted.
...
- Ecosystems **SHOULD** require AL3 or AL4 where failures create systemic risk, high-value fraud exposure, or high blast radius harms.
- Where a profile requires AL3/AL4 but actors only meet AL2/AL1, the ecosystem **SHALL** treat the actor as non-conforming for that profile.
